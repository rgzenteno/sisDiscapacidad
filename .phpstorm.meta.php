...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\sisdiscapacidad - Alacaldia - copia\public\storage' => 'string',
            ...
            'services.twilio.phone_number' => 'string',
            'services.whatsapp.api_key' => 'string',
            'services.whatsapp.url' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\xampp\\htdocs\\sisdiscapacidad - Alacaldia - copia\\public\\storage','logging.default',
...
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.twilio.sid',
'services.twilio.token','services.twilio.phone_number','services.whatsapp.api_key','services.whatsapp.url','session.driver',
...
'inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','sanctum.stateful',
...
'persona.reporteGeneral','persona.store','persona.estado','persona.update','persona.destroy',
'persona.edit','persona.importar','persona.importar.store','tutor.index','tutor.store',
'tutor.update','tutor.tutorados','tutor.metodo','tutor.cuentas','log.index',
'carnet.index','carnet.store','carnet.update','habilitado.index','habilitado.show',
'habilitado.showHabilitado','habilitado.store','habilitado.edit','historial.store','pago.index',
'pago.show','pago.store','pago.reporte','pago.reportePago','pago.reporteLog',
'pago.transferencia','pago.comp','reporte.index','reporte.buscar','usuario.index',
'usuario.store','usuario.update','dropdown.store','dropdown.addDis','tutorVista.index',
'tutorVista.ingresar','tutorVista.show','tutorVista.update','tutorVista.exit','tutorVista.cobros',
...
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.htdocs.sisdiscapacidad - Alacaldia - copia.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',
...
'validation.email','validation.ends_with','validation.exists','validation.file','validation.filled',
'validation.image','validation.in','validation.integer','validation.ip','validation.json',
'validation.max.numeric','validation.max.file','validation.max.string','validation.max.array','validation.mimes',
'validation.min.numeric','validation.min.file','validation.min.string','validation.min.array','validation.not_in',
...
'AWS_PHONE','VITE_APP_NAME','VITE_API_URL','BROADCAST_DRIVER','PUSHER_APP_ID',
