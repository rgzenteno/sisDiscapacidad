...
class RoleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Permisos del módulo "General": oculto del sidebar, tampoco debe
        // aparecer en el selector de permisos de Roles (no se elimina el
        // módulo ni los permisos existentes, solo se ocultan de esta vista).
        $hiddenPermissions = ['general', 'importar-general', 'agregar-general', 'pendiente-general'];
