...
class TutorController extends Controller
{
    ...
    {
        try {
            // Validar los datos de entrada según el esquema
            ...
            // Buscar el tutor
            $tutor = Tutor::findOrFail($validatedData['id_tutor']);

            // Preparar los datos para la creación de la cuenta
            $cuentaBancaria = CuentasBancarias::create([
                'id_tutor' => $validatedData['id_tutor'],
                'titular_cuenta' => $tutor->nombre_tutor,
    ...
    public function store(Request $request)
    {
        ...
        if ($existingTutor) {
            // Guardar el ID del tutor existente en la sesión
            ...
            // Crear nuevo tutor y guardar su ID en la sesión
