...
class PersonaController extends Controller
{
                        ...
                        if (count($datosActualizar) > 0) {
                            ...
                            if (!$tieneEstadoActivo) {
                                HistorialEstados::create([
                                    ...
                                    'fecha_fin' => null,
                                    'usuario_modificacion' => $nombreCompleto,
                                    'observaciones' => 'Alta inicial en el sistema - Datos completados por importación'
                                ]);
                            }
     ...
     */
    public function updateTutor(Request $request, string $id)
    {
        ...
        if (session('selected_tutor_id')) {
            ...
            // ✅ Limpiar observación eliminando "Tutor no proporcionado"
            if (!empty($persona->observacion_persona)) {
                $observacion = $persona->observacion_persona;
                // Eliminar "Tutor no proporcionado"
