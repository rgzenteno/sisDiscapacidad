...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('persona')->group(function () {
        ...
        Route::post('store', [PersonaController::class, 'store'])
            ->middleware('permission:crear-beneficiario')
            ->name('persona.store');
        ...
        Route::put('{id}/tutor', [PersonaController::class, 'updateTutor'])
            ->middleware('permission:asignaTutor-beneficiario')
            ->name('persona.updateTutor');

        Route::post('estado', [PersonaController::class, 'estado'])
            ->middleware('permission:estado-beneficiario')
            ->name('persona.estado');
    ...
    Route::prefix('tutor')->group(function () {
        ...
        Route::post('store', [TutorController::class, 'store'])
            ->middleware('permission:crear-tutor')
            ->name('tutor.store');
        ...
        Route::get('metodoPago', [TutorController::class, 'metodo'])
            ->middleware('permission:gestionar-metodos-pago')
            ->name('tutor.metodo');
        Route::post('cuentas/store', [TutorController::class, 'storeCuenta'])
            ->middleware('permission:gestionar-cuentas-tutor')
            ->name('tutor.cuentas'); */
    });
    ...
    Route::prefix('carnet')->group(function () {
        /* Route::get('index/{id}', [CarnetController::class, 'index'])
            ->middleware('permission:carnet')
            ->name('carnet.index'); */
        Route::post('store', [CarnetController::class, 'store'])
            ->middleware('permission:crearCarnet-beneficiario')
            ->name('carnet.store');
        Route::put('{id}', [CarnetController::class, 'update'])
            ->middleware('permission:editarCarnet-beneficiario')
            ->name('carnet.update');
    });
    ...
    Route::prefix('historial')->group(function () {
        Route::post('store', [HabilitadoController::class, 'store'])
            ->middleware('permission:crear-habilitados')
    ...
    Route::post('/admin/users/{user}/reset-password', [UserController::class, 'resetPassword'])
        ->middleware('permission:resert-usuario')
    ...
    Route::prefix('dropdown')->group(function () {
        Route::post('store', [DropDownController::class, 'store'])
            ->middleware('permission:discapacidad-beneficiario')
            ->name('dropdown.store');
        Route::post('addDis', [DropDownController::class, 'addDis'])
            ->middleware('permission:distrito-beneficiario')
