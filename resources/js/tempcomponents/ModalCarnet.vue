...
const getCurrentDate = (data) => {
    ...
    let dateStr = new Date(data).toLocaleDateString('es-ES', options);
    ...
    <div class="fixed inset-0 bg-slate-900/75 backdrop-blur-sm flex items-center justify-center p-4 z-40">
        <div
                    ...
                    <div class="flex-1 flex flex-col justify-center gap-3">
                        ...
                        <div class="flex">
                            ...
                            <div class="ms-6">
                                ...
                                <span
                                    class="uppercase text-sm font-semibold text-slate-800">{{ props.data.carnet?.discapacidad }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <span
                                    class="text-sm font-semibold text-slate-800 block mt-0.5">{{ getCurrentDate(props.data.carnet?.fecha_emision) }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <span
                                    class="text-sm font-semibold text-slate-800 block mt-0.5">{{ getCurrentDate(props.data.carnet?.fecha_vencimiento) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-6 py-4 border-t border-slate-200 rounded-b-3xl flex justify-end gap-3 bg-slate-50">
                ...
                <button v-if="can('editarCarnet-beneficiario')" type="button"
