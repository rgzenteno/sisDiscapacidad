...
<template>
    ...
    <div class="flex h-screen bg-gray-200 font-roboto">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <Header class="mb-0" />
            <ModalConfirmacion v-if="modalConfirm" :id="idHabi" :tipo="tipoHabi" @confirmar="submit"
                @close="closeModal" />
            <div class="py-2">
                            ...
                            <div class="bg-gray-50 p-2 rounded border">
                                ...
                                <div class="space-y-0.5 text-xs">
                                    ...
                                    <div class="flex">
                                        ...
                                        <span v-if="datosRecibo.tutor?.telefono">{{ datosRecibo.tutor?.telefono }}</span>
                                        <span v-else class="text-red-500 italic">Sin teléfono</span>
                                    </div>
                                    <div class="flex">
                                        <span class="text-gray-600 w-20 flex-shrink-0">Dirección:</span>
                                        <span v-if="datosRecibo.tutor?.direccion">{{ datosRecibo.tutor?.direccion }}</span>
