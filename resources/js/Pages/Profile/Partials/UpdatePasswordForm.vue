...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Asegúrese de que su cuenta utiliza una contraseña larga y aleatoria para permanecer
            segura.
        </p>
    </header>
    ...
    <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <TextInput ref="passwordInput" v-model="form.password" type="password" class="mt-1 block w-full" autocomplete="new-password" />
