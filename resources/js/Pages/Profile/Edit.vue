    ...
    <AuthenticatedLayout>
        <div class="flex h-screen bg-gray-50 font-roboto overflow-hidden">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex justify-between items-center p-4 pb-1 bg-white border-x-2 border-t-2 rounded-t-lg mr-1">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-white border-x-2 border-b-2 rounded-b-lg mr-1">
                        <div class="p-4 pt-0">
                            ...
                            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 mb-6">
                                ...
                                <div class="bg-white p-4 shadow-sm border rounded-lg sm:p-6 dark:bg-gray-800 dark:border-gray-700">
