...
const rolesOptions = computed(() => {
    return roles.value.map(role => ({
        text: role.name.toUpperCase(), // Convierte a mayúsculas para mostrar
        value: role.name // El valor que se enviará al backend
    }));
});
        ...
        <div class="flex h-screen bg-gray-200 font-roboto">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <Form v-if="openFormEdit" :fields="usuarioEditFields" boton-name="Guardar"
                    ...
                    submit-label="Editar Usuario" submit-route="usuario.update" @add="handleUpdate"
                    @cancel="closeForm" />
                ...
                <div class="flex justify-between p-4 pb-3 bg-gray-50 border-x-2 border-t-2 rounded-t-lg mr-1">
                    ...
                    <Button v-if="can('crear-usuario')" id="btn-agregar" @click.prevent="openFormCreate()"
                ...
                <main class="flex-1 overflow-y-auto bg-white border-b-2 border-x-2 rounded-b-lg mr-1">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <div v-for="(usuariosDelRol, rolNombre) in usuariosAgrupadosPorRol" :key="rolNombre">
                                ...
                                <div v-for="item in usuariosDelRol" :key="item.id"
                                    ...
                                    <div class="flex justify-between items-start mb-3">
                                        <div class="flex-1 flex items-center gap-2">
                                            <h3 class="text-base font-bold text-gray-800 dark:text-white capitalize">
                                                {{ getFirstName(item.nombre) }} {{ item.apellido }}
                                            </h3>
                                            <!-- Badge inline -->
                                        ...
                                        <div class="flex space-x-1 ml-2">
                                            ...
                                            <button v-if="can('editar-usuario')" @click="openEditUsuario(item, item.id)"
                                                class="p-1.5 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200"
                                            ...
                                            <button v-if="$page.props.auth.user.id !== item.id && can('resert-usuario')"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p
                                                class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase truncate">
                                                {{ item.cargo }}
                                            </p>
                            ...
                            <!-- ✅ Componente ResetPasswordModal -->
                            <ResetPasswordModal v-if="showResetModal" :user="selectedUserForReset"
