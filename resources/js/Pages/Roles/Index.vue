    ...
    <AuthenticatedLayout>
        ...
        <div class="flex h-screen bg-gray-200 font-roboto">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <Form v-if="formEditRol" :fields="fieldRoles" boton-name="Guardar" :permissions="permissions" :idFor="selectedId"
                    :existing-data="selectedItem || {}" :edit-mode="true" submit-route="roles.update" @add="handleEdit"
                    @sinDatos="sinDatos" @cancel="closeForm" @close="closeForm">
                    <template #icon>
                        <svg class="w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd"
                ...
                <div v-if="selectedRole"
                    ...
                    <div class="relative bg-white rounded-3xl shadow-2xl max-w-2xl w-full mx-4 flex flex-col max-h-[85vh]"
                        @click.stop>
                        <!-- Header del Modal -->
                        <div
                        ...
                        <div class="p-6 overflow-y-auto flex-1 bg-gray-50 dark:bg-gray-900">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" placeholder="Buscar permisos..." class="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            </div>
                        </div> -->
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div v-for="(permission, index) in selectedRole.permissions" :key="index"
                                    class="group relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-200 hover:-translate-y-0.5">

                                    <div class="flex items-start gap-3">
                                        <!-- Icono de check -->
                                        <div
                                            class="flex-shrink-0 w-8 h-8 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                        ...
                        <!-- Footer del Modal -->
                        <div
                            class="px-6 py-4 bg-gray-100 dark:bg-gray-800 border-t border-gray-200 rounded-b-3xl dark:border-gray-700 flex items-center justify-between">
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                <!-- Total de permisos: <span class="font-semibold text-gray-900 dark:text-gray-100">{{ selectedRole.permissions.length }}</span> -->
                            </div>
...
// CORREGIR: Cambiar 'label' por 'text'
onMounted(() => {
    if (props.permissions && props.permissions.length > 0) {
        fieldRoles[1].options = props.permissions.map(permission => ({
