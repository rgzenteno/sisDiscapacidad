...
/**
 * Navega a la vista de tutorados del tutor indicado
 * @param {string} ruta - Nombre de la ruta
 * @param {number|string} id - ID del tutor a codificar como parámetro
 */
...
/**
 * Abre WhatsApp con un mensaje predefinido al número indicado
 * @param {string} telefono - Número de teléfono del tutor
 */
...
/**
 * Abre el cliente de correo con destinatario y asunto predefinidos
 * @param {string} email - Dirección de correo electrónico del tutor
 */
 ...
 * @param {number|string} idTutor - ID del tutor
 */
...
<template>
    <AppLayout :mensajes="mensajes" @cerrarMensaje="cerrarMensaje">
        ...
        <DataTable :data="tutor.data" :columns="tableColumns" row-key="id_tutor"
            ...
            <template #empty>
                <div class="flex flex-col items-center justify-center py-12 px-4">
                    <!-- Icono simple -->
                    <div class="mb-6">
                        <Icon :icon-button="true" name="users" class-name="text-gray-400 dark:text-gray-500" :size="64"
                            :height="64" />
                    </div>
        ...
        <Transition name="fade">
            <Form v-if="formEditTutor" :fields="tutorFieldsEdit" boton-name="Guardar"
                :existing-data="selectedItem || {}" :idFor="selectedId" :edit-mode="true" submit-route="tutor.update"
