...
<template>
    ...
    <div class="flex h-screen bg-gray-200 font-roboto">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <Form v-if="formEditTutor" :fields="tutorFields" boton-name="Guardar" :existing-data="selectedItem || {}" :idFor="selectedId"
                :edit-mode="true" submit-label="Editar Tutor" submit-route="tutor.update" @add="handleUpdate"
                @cancel="closeForm">
                <template #icon>
                ...
                <template #row="{ item }">
                    ...
                    <td class="px-3 py-1.5">
                        <div class="flex justify-center items-center gap-1">
                            <Icon v-if="can('editar-tutor')" @click.prevent="openEditTutor(item, item.id_tutor)" name="userEdit"
                                class-name="text-gray-700" />
                            <Icon v-if="can('tutorados-tutor')" @click.prevent="getTutoradosUrl('tutor.tutorados', item.id_tutor)" name="usersGroup"
                                class-name="text-gray-700" />
                        </div>
                    </td>
                </template>
