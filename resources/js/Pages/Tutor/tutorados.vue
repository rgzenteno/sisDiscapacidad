...
<template>
    <AppLayout>
        ...
        <!-- ============================================================================ -->
        <!-- INFORMACION DATOS DEL TUTOR -->
        <!-- ============================================================================ -->
        <div class="bg-white border-x-2 border-t-2 rounded-t-lg mr-1">
            <div class="p-4 pb-0">
                <div class="flex items-center justify-between mb-3">
                    <h3 class="text-lg font-semibold text-[rgb(var(--brand-800))] flex items-center">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between capitalize">
                        <span class="text-[rgb(var(--brand-600))] font-medium">{{ tutorData.nombre_tutor }} {{
                            tutorData.apellido_tutor }}</span>
                        <span class="text-gray-600">Cant. Tutorados: <span
                                class="font-bold text-xl text-[rgb(var(--brand-500))] px-3">{{ totalPersonas }}</span></span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="flex items-center space-x-1">
                            <span class="relative inline-block">
                                <div
                                    ...
                                    <svg v-if="item.estado === 'activo'" class="w-4 h-4 text-green-500 dark:text-white"
