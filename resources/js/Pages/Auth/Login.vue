...
<template>
    ...
    <div class="flex font-roboto">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="bg-[rgb(var(--brand-dark-rgb))] flex items-center justify-center relative overflow-hidden px-2"
                :style="{ ...estiloBrand, height: '100dvh' }">

                <!-- Círculos de fondo: tamaño reducido en mobile con clases responsive -->
                <div>
                    <!-- Superior izquierda -->
                    <div
                        class="absolute top-0 left-0 w-48 h-48 sm:w-96 sm:h-96 bg-[rgba(var(--brand-rgb),0.2)] rounded-full transform -translate-x-16 sm:-translate-x-32 -translate-y-16 sm:-translate-y-32 opacity-60 blur-sm">
                    </div>
                    <div
                    ...
                    <div
                        class="absolute top-20 -left-4 w-28 h-28 sm:w-52 sm:h-52 bg-[rgba(var(--brand-rgb),0.25)] rounded-full opacity-40 blur-sm">
                    </div>
                    <div
                        class="absolute top-40 left-24 w-20 h-20 sm:w-36 sm:h-36 bg-[#AAAAAE]/20 rounded-full opacity-35 blur-sm">
                    </div>
                    <div
                        class="absolute top-56 left-6 w-16 h-16 sm:w-28 sm:h-28 bg-[rgba(var(--brand-rgb),0.3)] rounded-full opacity-30 blur-sm">
                    </div>
                    <!-- Inferior derecha -->
                    <div
                    ...
                    <div
                        class="absolute bottom-10 right-16 w-36 h-36 sm:w-64 sm:h-64 bg-[rgba(var(--brand-rgb),0.2)] rounded-full transform translate-x-8 sm:translate-x-16 translate-y-6 sm:translate-y-12 opacity-55 blur-sm">
                    </div>
                    <div
                ...
                <div
                    class="backdrop-blur-sm z-20 rounded-3xl shadow-2xl border border-[rgba(var(--brand-rgb),0.2)] w-full sm:max-w-none sm:w-auto">
                    <div class="flex rounded-3xl overflow-hidden">
                        ...
                        <div
                            ...
                            <form @submit.prevent="submit">
                                <div class="space-y-7 py-4 sm:space-y-4 px-2 sm:px-6 sm:py-0">
                                    <!-- Usuario -->
                                    <div class="space-y-2 sm:space-y-7">
                                        <div>
                                            ...
                                            <input v-model="form.email" id="email" type="text" required autofocus
                                                autocomplete="off"
                                                class="w-full px-4 py-2 bg-[rgba(var(--brand-dark-rgb),0.8)] border border-[#7D838E] rounded-lg text-white placeholder-[#7D838E] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--brand-rgb))] focus:border-[rgb(var(--brand-rgb))] transition duration-200"
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input v-model="form.password" id="password"
                                                    ...
                                                    class="w-full px-4 py-2 bg-[rgba(var(--brand-dark-rgb),0.8)] border border-[#7D838E] rounded-lg text-white placeholder-[#7D838E] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--brand-rgb))] focus:border-[rgb(var(--brand-rgb))] transition duration-200 pr-12"
                                                    placeholder="••••••••" />
                                    ...
                                    <div class="flex justify-between text-sm">
                                        <label class="text-[#B9B8BD] cursor-pointer">
                                            <input v-model="form.remember" type="checkbox"
                                                class="w-4 h-4 text-[rgb(var(--brand-rgb))] bg-[rgb(var(--brand-dark-rgb))] border-[#7D838E] rounded focus:ring-[rgb(var(--brand-rgb))] focus:ring-2" />
                                            <span class="ml-2">Recuérdame</span>
                                        </label>
                                        <Link v-if="canResetPassword" :href="route('password.request')"
                                            class="text-[rgb(var(--brand-rgb))] hover:text-[#AAAAAE] transition duration-200">
                                        </Link>
                                    </div>
                                    <!-- Botón submit -->
                                    <button type="submit" :disabled="form.processing"
                                        class="mx-auto block w-56 bg-gradient-to-r from-[rgb(var(--brand-rgb))] to-[rgba(var(--brand-rgb),0.8)] hover:from-[rgba(var(--brand-rgb),0.9)] hover:to-[rgb(var(--brand-rgb))] text-white font-semibold py-2 sm:py-1.5 px-4 rounded-full transition duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border border-[rgba(var(--brand-rgb),0.5)]">
                                ...
                                <div class="">
                                    ...
                                    <div class="flex items-center gap-2 my-6">
                                        <div
                                            class="flex-1 h-px bg-gradient-to-r from-transparent via-gray-100 to-transparent">
                                        </div>
                                        <div class="flex items-center justify-center">
                                            <span class="text-sm text-[#7D838E]">Sistema Municipal</span>
                                        </div>
                                        <div
                                            class="flex-1 h-px bg-gradient-to-r from-transparent via-gray-100 to-transparent">
                                        </div>
                                    ...
                                    <div class="text-center space-y-2">
                                        <p class="hidden sm:block text-[#7D838E] text-xs">
