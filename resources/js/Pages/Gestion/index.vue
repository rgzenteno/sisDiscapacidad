 ...
 */
const openFormEdit = () => {
    selectedId.value = año_actual.value.id;
    selectedItem.value = año_actual.value;
    formEdit.value = true;
}
...
<template>
    ...
    <div class="flex h-screen bg-gray-200 font-roboto">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <Form v-if="formEdit" :fields="gestionEditFields" boton-name="Guardar" :existing-data="selectedItem || {}" :idFor="selectedId"
                :edit-mode="true" submit-route="gestion.update" @add="handleUpdate" @cancel="closeForm">
                <template #icon>
                    <Icon :icon-button="true" name="calendarEdit" class-name="text-white" />
                </template>
                <template #label1>
                    Editar gestión {{ año_actual.añoActualSistema }}
                </template>
                <template #label2>
            ...
            <Form v-if="formEditMes" :fields="mesEditFields" boton-name="Guardar" :existing-data="selectedItem || {}" :idFor="selectedId"
                :personasValidas="total_personas_validas" :edit-mode="true" submit-route="gestion.updateMes"
                @add="handleUpdate" @cancel="closeForm">
                <template #icon>
                    <Icon :icon-button="true" name="calendarEdit" class-name="text-white" />
                </template>
                <template #label1>
            ...
            <div
                ...
                <div v-if="!gestionData && can('crearGestion-gestion')" class="flex justify-center lg:col-span-1">
                    ...
                    <Dropdown align="left" width="60">
                        ...
                        <template #content>
                            <div
                                ...
                                <div v-if="btnAgregar === false && can('crearGestion-gestion')"
                ...
                <div class="justify-self-center text-center lg:col-span-2">
                    ...
                    <div v-else class="space-y-1">
                        <h1
                            class="text-2xl font-bold text-slate-800 tracking-tight bg-gradient-to-r from-slate-700 to-slate-900 bg-clip-text text-transparent">
                            Aún no hay gestiones registradas
                        </h1>
                        <p class="text-sm text-gray-600">Para comenzar, cree una nueva gestión académica.</p>
                    </div>
                </div>
                ...
                <div class="justify-self-end lg:col-span-1 relative flex gap-2">
                    <!-- Botón: Agregar -->
                    <Button
                        v-if="can('crearMes-gestion') && año_actual.id === null ? false : (mes_actual_disponible !== 0 ? true : false)"
                    ...
                    <!-- Botón: Editar -->
                    <Button v-if="can('editarGestion-gestion') && existe_gestion ? true : false" id="btn-editar"
                    ...
                    <!-- Botón: Generar PDF -->
                    <Button v-if="can('reporteGestion-gestion') && existe_gestion && tiene_meses && gestion.length > 0"
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <div class="relative">
                                                <div :class="{
                                                    ...
                                                    <span
                                                        v-if="item.cantidad_habilitadas !== item.cantidad_total_pagos && !verifyDate(item.gestion, item.mes)"
                                            ...
                                            <!-- Edit Button -->
                                            <div v-if="can('editarMes-gestion')" class="pb-0">
                                                <Icon
