...
console.log('datos: ', misPagosTodos.value);
...
const pagosTodos = computed(() => page.props.pagosTodos ?? []);

const hayDatosTabGeneral = computed(() => pagosTodos.value?.length > 0 && buscado.value);
...
const columnasIndividual = [
    ...
    { key: 'ci_persona', label: 'Cédula de Identidad' },
...
const columnasResumen = [
    ...
    { key: 'cantidad', label: 'Cantidad Beneficiarios', headerClass: 'text-center' },
    { key: 'monto_unitario', label: 'Monto Unitario (Bs)', headerClass: 'text-center' },
    { key: 'total', label: 'Total Monto (Bs)', headerClass: 'text-center' },
    ...
    <div class="flex h-screen bg-gray-200 font-roboto">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="px-5 py-3 flex justify-between">
                <h1 class="font-semibold text-2xl">Bandeja de Pagos</h1>
                <Rutas label1="Inicio" label3="Bandeja de Pagos" />
            </div>

            <!-- ============================================================================ -->
            <!-- FILTROS + RESUMEN + BOTONES -->
            <!-- ============================================================================ -->
            <div class="p-3 bg-white border-x-2 border-t-2 border-gray-200 rounded-t-lg mr-1 shadow-sm">
                ...
                <div class="flex flex-wrap items-center gap-2 mt-2">
                    ...
                    <Transition name="filtro">
                        <div v-if="!hayFiltrosActivos" class="flex items-center shrink-0">
                            <span
                        ...
                        <div v-if="!gestionMesActivo"
                            ...
                            <div class="flex flex-col gap-0.5">
                                ...
                                <input type="date" v-model="filtroDesde" @change="onRangoChange"
                                    class="border rounded-lg px-2.5 py-1.5 text-sm font-medium bg-white focus:outline-none focus:ring-2 focus:ring-purple-300 transition-all w-32 sm:w-36"
                    ...
                    <button v-if="hayFiltrosActivos" @click="limpiarFiltros"
                        class="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-red-500 bg-red-50 border border-red-100 rounded-xl hover:bg-red-100 hover:border-red-300 hover:text-red-700 transition-all duration-200 shrink-0 h-fit self-end mb-0.5">
            ...
            <div class="flex border-x-2 border-gray-200 bg-white mr-1">
                ...
                <button v-if="can('acciones-superusuario')" @click="cambiarTab('resumen')" :class="[
                    'flex items-center gap-2 px-5 py-2.5 text-sm font-semibold border-b-2 transition-colors duration-200',
                    tabActivo === 'resumen'
            ...
            <!-- ============================================================================ -->
            <template v-if="can('acciones-superusuario') && tabActivo === 'resumen'">
                <DataTable :data="resumenGeneral" :columns="columnasResumen" row-key="nro"
            ...
            <!-- Footer -->
            <div>
                <Paginacion v-if="misPagos?.last_page > 1" :links="misPagos.links" :from="misPagos.from"
                    :to="misPagos.to" :total="misPagos.total" />
                <Footer />
            </div>
