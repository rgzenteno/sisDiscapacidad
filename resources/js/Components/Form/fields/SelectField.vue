...
const selectedOptionText = computed(() => {
    ...
    return selectedOption ? selectedOption.text : props.modelValue;
});
        ...
        <Dropdown align="left" width="60">
            ...
            <template #content>
                <div class="w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <ul class="py-1">
                            ...
                            <li v-for="option in field.options" :key="option.value">
                                ...
                                >
                                    ...
                                    <svg
                                        v-if="modelValue && modelValue.toString() === option.value.toString()"
                    ...
                    <div v-if="field.add && (can('distrito-beneficiario') || can('discapacidad-beneficiario'))" class="border-t border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
                        <button
                            type="button"
                            @click="emit('openFormOption')"
