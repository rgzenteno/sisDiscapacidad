...
/**
 * Retorna las clases y el ícono SVG correspondientes al tipo de mensaje
 */
...
/**
 * Oculta el mensaje con animación de salida y emite el evento de cierre
 */
const cerrarMensaje = () => {
    isVisible.value = false;
    setTimeout(() => emit('close', props.id), 1000);
};
</script>
