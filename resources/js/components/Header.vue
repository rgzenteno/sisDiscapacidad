    ...
    <AuthenticatedLayout>
        <header
            ...
            <div class="block sm:hidden font-extrabold items-center justify-center">
                <span class="text-3xl text-[rgb(var(--brand-dark-rgb))] dark:text-white"
                    style="text-shadow: 0 0 1px rgb(var(--brand-dark-rgb)), 1px 0 0px rgb(var(--brand-dark-rgb)), 0px 0 0px rgb(var(--brand-dark-rgb)), -5px 5px 4px rgb(158 158 158 / 90%);">UMADIS</span>
            </div>
                ...
                <div class="ms-1 relative">
                    <div class="relative flex justify-between">
                        ...
                        <button ref="triggerBtn" @click="toggleDropdown"
                            ...
                            <div v-else
                                class="w-10 h-10 rounded-full overflow-hidden bg-gradient-to-br from-[rgb(var(--brand-rgb))] to-[rgb(var(--brand-dark-rgb))] ring-2 ring-white/10 dark:ring-gray-800/80">
                                <span
                            ...
                            <div v-show="dropdownOpen"
                                ...
                                <div class="pt-5 pb-2 border-b border-gray-100 dark:border-gray-700">
                                    <div class="flex flex-col items-center space-y-1">
                                        <!-- Avatar -->
                                        <div
                                            class="w-16 h-16 rounded-full mb-3 overflow-hidden bg-gradient-to-br from-[rgb(var(--brand-rgb))] to-[rgb(var(--brand-dark-rgb))] ring-2 ring-gray-200 dark:ring-gray-600">
                                            <span
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p
                                                class="text-xs text-gray-500 dark:text-gray-400 uppercase text-center leading-snug break-words line-clamp-2">
                                ...
                                <div class="py-2">
                                    ...
                                    <!-- Configuración (logos institucionales) — solo superUsuario -->
                                    <ResponsiveNavLink v-if="hasRole('superUsuario')" :href="route('configuracion.index')"
                                        class="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 group transition-colors">
                                        <svg width="24" height="24" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="text-gray-500 group-hover:text-gray-700 dark:group-hover:text-gray-300"
