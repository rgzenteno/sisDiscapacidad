...
/**
 * Formatea un objeto de gestión como texto legible (ej: "Enero 2024")
 * @param {{ mes: number, año: number }|null} g - Objeto de gestión
 * @returns {string|null} Texto formateado o null si no hay datos
 */
...
const allMissingItems = computed(() => [
    ...(props.validation.missingColumns ?? []),
    ...(props.validation.missingFields ?? [])
]);
...
// ============================================================================
// COMPUTED - ESTILOS SEGÚN ESTADO DE VALIDACIÓN
// ============================================================================

/**
 * Retorna las clases Tailwind del componente según el resultado de validación:
 * verde = válido, rojo = inválido, azul = pendiente
 */
const estilos = computed(() => {
    ...
    return {
        card:   'border-[rgb(var(--brand-200))] dark:border-[rgb(var(--brand-700))]',
        header: 'bg-[rgb(var(--brand-50))] dark:bg-[rgba(var(--brand-900),0.2)]',
        body:   'bg-white dark:bg-gray-900 border-[rgb(var(--brand-100))] dark:border-[rgb(var(--brand-800))]',
        iconBg: 'bg-[rgb(var(--brand-100))] dark:bg-[rgba(var(--brand-800),0.5)]',
        icon:   'text-[rgb(var(--brand-600))] dark:text-[rgb(var(--brand-400))]',
        text:   'text-[rgb(var(--brand-700))] dark:text-[rgb(var(--brand-300))]',
    };
});
</script>
