...
<template>
    <div @drop.prevent="emit('drop', $event)" @dragover.prevent="emit('dragover')"
        @dragleave.prevent="emit('dragleave')" @click="emit('click')" :class="[
            ...
            isDragging
                ? 'border-[rgb(var(--brand-400))] bg-[rgb(var(--brand-50))] dark:bg-[rgba(var(--brand-950),0.3)] dark:border-[rgb(var(--brand-500))]'
                : error
        ...
        <div class="flex flex-col items-center gap-3 pointer-events-none">
            ...
            <div :class="[
                ...
                isDragging
                    ? 'bg-[rgb(var(--brand-100))] dark:bg-[rgba(var(--brand-900),0.4)]'
                    : error
                ...
                <!-- Ícono dragging -->
                <svg v-else-if="isDragging" class="w-5 h-5 text-[rgb(var(--brand-500))]" viewBox="0 0 24 24" fill="none"
            ...
            <div class="space-y-1">
                <p :class="[
                    'text-sm font-medium',
                    isDragging ? 'text-[rgb(var(--brand-600))] dark:text-[rgb(var(--brand-400))]'
                ...
                <p v-if="!isDragging" :class="[
                    ...
                    o <span :class="error ? '' : 'text-[rgb(var(--brand-500))] hover:underline'">haz clic para seleccionar</span>
                </p>
            </div>
            ...
            <span :class="[
                ...
                isDragging
                    ? 'bg-[rgb(var(--brand-100))] text-[rgb(var(--brand-700))] border-[rgb(var(--brand-200))] dark:bg-[rgba(var(--brand-900),0.4)] dark:text-[rgb(var(--brand-300))] dark:border-[rgb(var(--brand-800))]'
                    : error
