...
<template>
    <div @click="toggle"
        class="flex items-center gap-3 px-2 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors select-none">
        ...
        <div class="relative flex-shrink-0 w-10 h-[22px] rounded-full transition-colors duration-200"
            :class="isChecked ? 'bg-[rgb(var(--brand-500))]' : 'bg-gray-300 dark:bg-gray-600'">
