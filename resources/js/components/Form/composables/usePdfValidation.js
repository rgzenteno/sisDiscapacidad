            ...
            reader.onload = async (e) => {
                try {
                    ...
                    if (missingFields.length > 0) {
                        return resolve({
                            isValid: false,
                            message: "✗ El PDF no tiene el formato esperado",
                            missingFields,
                            foundFields,
                    ...
                    if (expectedGestion) {
                        if (
                            ...
                            resolve({
                                isValid: false,
                                message: '✗ El mes del PDF no coincide con la gestión actual',
                                missingFields: [],
                                foundFields,
                                extractedData: {
                    ...
                    resolve({
                        isValid: true,
                        message: "✓ PDF válido", // ← sin repetir la gestión en el mensaje
                        missingFields: [],
                        foundFields,
                        extractedData: {
                            gestion: extractedGestion,
