...
export function useFormState(props, emit) {
    ...
    const form = useForm({
        ...
        ...(props.fields || []).reduce((acc, field) => {
            ...
            else if (field.typeInput === 'propio_check') {
                acc[field.name] = 0; // siempre inicia descheckeado
            }
        ...
        (newData) => {
            if (props.editMode && newData) {
                (props.fields || []).forEach((field) => {
                    ...
                    // Caso especial para propio_check: siempre 0
            ...
            if (newData?.id_persona) {
                form.id_persona = newData.id_persona;
            }
        },
